  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('turnos/create') ?>" method="post" id="createForm">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('turnos/update') ?>" method="post" id="updateForm">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('turnos/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
  ...
  function updateTurnos(id) {
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#edit_nombre").val(response.turno_nombre);
