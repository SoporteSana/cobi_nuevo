<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Categoria productos</li>
    </ol>
  </section>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('categoriaproducto/create') ?>" method="post" id="createForm">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('categoriaproducto/update') ?>" method="post" id="updateForm">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('categoriaproducto/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $("#categoriaproductosNav").addClass('active');

    manageTable = $('#manageTable').DataTable({
      'ajax': 'fetchCategoriaProductosData',
      'order': []
    });
  ...
  function updateCategoriaProductos(id) {
    $.ajax({
      url: 'fetchCategoriasProductoDataById/' + id,
      type: 'post',
      dataType: 'json',
      success: function(response) {

        $("#edit_nombre").val(response.categoriaProducto_nombre);
  ...
  function deleteCategoriaProductos(id) {
    if (id) {
