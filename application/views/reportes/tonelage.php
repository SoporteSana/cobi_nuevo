        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="manageTable" class="display responsive nowrap" style="width:100%">
              ...
              <tbody>
                <?php foreach ($tonelages as $tonelage) : ?>
                  <tr>
                    <td><?= $tonelage['registro_id'] ?></td>
                    <td><?= $tonelage['unidad_numero'] ?></td>
                    <td><?= $tonelage['totalpeso'] ?></td>
                    <td><?= $tonelage['asignacion_nombre'] ?></td>
                    <td><?= $tonelage['fecha_salida'] ?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
