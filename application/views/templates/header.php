...
<script src="<?php echo base_url('assets/plugins/datatables/jquery.dataTables.min.js') ?>"></script>
  <!-- exportar a excel -->
<script src="<?php echo base_url('assets/plugins/datatables/xlsx.full.min.js') ?>"></script>

  <!-- timepicker -->
<script src="<?php echo base_url('assets/plugins/timepicker/tempusdominus-bootstrap-4.min.js') ?>"></script>
  <!-- timepicker -->
<script src="<?php echo base_url('assets/plugins/timepicker/es.js') ?>"></script>
