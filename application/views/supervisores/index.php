  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createSupervisor', $user_permission)) : ?>
          ...
          <table id="manageTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>Sucursal</th>
                <th>Estatus</th>
                <?php if (in_array('updateSupervisor', $user_permission)) : ?>
                  <th>Accion</th>
                <?php endif; ?>
            </thead>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('supervisores/create') ?>" method="post" id="createForm">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('supervisores/update') ?>" method="post" id="updateForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input readonly type="text" class="form-control" id="edit_nombre" name="edit_nombre" placeholder="nombre" autocomplete="off">
            </div>
            <div class="form-group">
              <label for="edit_sucursal">Sucursal</label>
              <input readonly type="text" class="form-control" id="edit_sucursal" name="edit_sucursal" placeholder="sucursal" autocomplete="off">
            </div>
            <div class="form-group">
...
<?php if (in_array('deleteSupervisor', $user_permission)) : ?>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('supervisores/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $("#supervisoresNav").addClass('active');


    manageTable = $('#manageTable').DataTable({
      'ajax': 'fetchSupervisorData',
      'order': []
    });
  ...
  function updateSupervisor(id) {
    $.ajax({
      url: 'fetchSupervisorDataById/' + id,
      type: 'post',
      dataType: 'json',
      success: function(response) {

        $("#edit_nombre").val(response.nombre_completo);
        $("#edit_sucursal").val(response.sucursal_nombre);
