  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createEmpresa', $user_permission)) : ?>
          ...
          <table id="manageTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Nombre</th>
                <th>Estatus</th>
                <?php if (in_array('updateEmpresa', $user_permission) || in_array('deleteEmpresa', $user_permission)) : ?>
                  <th>Accion</th>
                <?php endif; ?>
              </tr>
            </thead>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Empresas/create') ?>" method="post" id="createForm">
...
<?php if (in_array('updateEmpresa', $user_permission)) : ?>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Empresas/update') ?>" method="post" id="updateForm">
...
<?php if (in_array('deleteEmpresa', $user_permission)) : ?>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Empresas/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#EmpresasNav").addClass('active');

    manageTable = $('#manageTable').DataTable({
      'ajax': 'fetchEmpresasData',
      'order': []
    });
  ...
  function updateEmpresa(id) {
    $.ajax({
      url: 'fetchEmpresasDataById/' + id,
      type: 'post',
      dataType: 'json',
      success: function(response) {

        $("#edit_name").val(response.empresa_nombre);
