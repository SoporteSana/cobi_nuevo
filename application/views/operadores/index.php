  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createOperador', $user_permission)) : ?>
          ...
          <table id="manageTable" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Nombre</th>
                <th>Estatus</th>
                <?php if (in_array('updateOperador', $user_permission) || in_array('deleteOperador', $user_permission)) : ?>
                  <th>Accion</th>
                <?php endif; ?>
              </tr>
            </thead>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Operadores/create') ?>" method="post" id="createForm">
...
<?php if (in_array('updateOperador', $user_permission)) : ?>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Operadores/update') ?>" method="post" id="updateForm">
...
<?php if (in_array('deleteOperador', $user_permission)) : ?>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('Operadores/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#operadoresNav").addClass('active');

    manageTable = $('#manageTable').DataTable({
      'ajax': 'fetchOperadoresData',
      'order': []
    });
  ...
  function updateOperador(id) {
    $.ajax({
      url: 'fetchOperadoresDataById/' + id,
      type: 'post',
      dataType: 'json',
      success: function(response) {

        $("#edit_name").val(response.operador_nombre);
