...
class Users extends Admin_Controller
{
	...
	public function index()
	{
		...
		if (!empty($user_data)) {
			foreach ($user_data as $k => $v) {
				...
				$group = $this->model_users->getUserGroup($v['usuario_id']);
	...
	public function create()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$empresas_data = $this->model_users->getEmpresasData();
			$this->data['group_data'] = $group_data;
			$this->data['empresas_data'] = $empresas_data;
	...
	public function delete($usuario_id)
	{
		...
		if ($usuario_id) {
			...
			$update = $this->model_users->edit($data, $usuario_id);
			if ($update == true) {
	...
	public function sucursaleslist($empresa_id)
	{
		$data = $this->model_users->getSucursalesData($empresa_id);
